    ...
    for epoch in range(hyperparams["epochs"]):
        ...
        if valid_loss < best_valid_loss:
            ...
            if hyperparams["model_dir"]==None:
                ...
                torch.save(model.state_dict(), f"QuixerTuning/{hyperparams['dataset']}/{hyperparams['parcel_type']}/classical_{hyperparams['model_dir']}_{hyperparams['lossfunction']}_{hyperparams['seed']}_{tuning_set}.pt")
