...
def get_args():
    ...
    parser.add_argument("--model-dir", type=str, default='ABCD_fluidintell_regress.pt')  
...
def save_progress(completed_sets, progress_file=f"QuixerTuning/{args.dataset}/{args.parcellation}/{args.target}_{args.lossfunction}_{args.seed}_training_progress.json"):
    """Save the indices of completed hyperparameter sets"""
    with open(progress_file, 'w') as f:
        json.dump({'completed_sets': completed_sets}, f)

def load_progress(progress_file=f"QuixerTuning/{args.dataset}/{args.parcellation}/{args.target}_{args.lossfunction}_{args.seed}_training_progress.json"):
